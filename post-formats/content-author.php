<?php
    $enable_author_box = get_user_meta( 'tekz_enable_author_box', false );
    $user_id  = get_current_user_id();
    $user_meta = get_user_meta( $user_id, 'tekz_user_option', true );
    $tekz_user_social = isset( $user_meta['tekz_user_social'] ) ? $user_meta['tekz_user_social'] : [];
...
?>
 <div class="blog-details-comment-item mt-30">
    ...
    <div class="content-wrap">
        ...
        <?php foreach( $tekz_user_social as $userSocail ) : ?>
            <li>
                <a href="<?php echo esc_url($userSocail['tekz_user_social_link']); ?>"><i class="<?php echo esc_attr($userSocail['tekz_user_social_icon']); ?>"></i></a>
            </li>
        <?php endforeach; ?>
        </ul>
    </div>
