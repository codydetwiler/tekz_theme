...
<?php if ( get_comments_number() >= 1 ): ?>
    <div class="post-comments-wrapper blog-details-comments-wrap mb-40 log-comment-list-wrap">
        <div class="comment-title-wrapper group-title mb-25">
            <?php
                ...
                $comment_text = ( !empty( $comment_no ) AND ( $comment_no > 1 ) ) ? esc_html__( 'Comments', 'tekz' ) : esc_html__( ' Comment ', 'tekz' );
    ...
    <div class="comment-pagination mb-50">
        <nav id="comment-nav-below" class="comment-navigation" role="navigation">
            <h1 class="screen-reader-text"><?php esc_html_e( 'Comment navigation', 'tekz' );?></h1>
            <div class="row">
                <div class="col-md-6">
                    <div class="nav-previous "><?php previous_comments_link( esc_html__( '&larr; Older ', 'tekz' ) );?></div>
                </div>
                <div class="col-md-6">
                    <div class="nav-next "><?php next_comments_link( esc_html__( 'Newer &rarr;', 'tekz' ) );?></div>
                </div>
            </div>
